...
export const Item = ({
    ...
    return(
        <div 
            ...
            className={cn(
                "group min-h-[27px] text-sm pr-3 w-full hover:bg-primary/5 flex items-center text-muted-foreground hover:cursor-pointer font-medium",
        ...
        >
            {!!id && (
                <div 
                    role="button" 
                    className="h-full rounded-full hover:bg-neutral-300 dark:bg-neutral-600 mr-2 my-1.5"
