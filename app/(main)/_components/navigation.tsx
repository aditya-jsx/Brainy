  ...
  return (
    <>
        <aside ref={sideBarRef} className={cn(
            ...
            <div className={cn(
                "h-6 w-6 text-muted-foreground rounded-sm hover:bg-nuetral-300 dark:hover:bg-nuetral-600 absolute top-3 right-2 opacity-0 group-hover/sidebar:opacity-100 transition duration-300",
